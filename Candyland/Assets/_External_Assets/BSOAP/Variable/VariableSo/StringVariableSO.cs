...
{
    /// <summary>
    /// Serializable class that represents a string scriptable object variable.
    /// </summary>
    [Serializable]
    [CreateAssetMenu(menuName = "BSOAP/Values/StringValue", fileName = "SS_")]
    public class StringVariableSO : ScriptableObject
    {
        ...
        public string Value
        {
            ...
            {
                if (DebugMode)
                    Debug.Log($"Variable {name} changed value from \"{Value}\" to \"{value}\"");
