...
{
    /// <summary>
    /// Serializable class that represents a Vector4 scriptable object variable.
    /// </summary>
    [Serializable]
    [CreateAssetMenu(menuName = "BSOAP/Values/Vector4Value", fileName = "BV4_")]
    public class Vector4VariableSO : ScriptableObject
    {
        /// <summary>
