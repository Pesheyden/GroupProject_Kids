...
{
    /// <summary>
    /// Serializable class that represents a Vector2 scriptable object variable.
    /// </summary>
    [Serializable]
    [CreateAssetMenu(menuName = "BSOAP/Values/Vector2Value", fileName = "BV2_")]
