...
{
    /// <summary>
    /// Serializable class that represents a boolean scriptable object variable.
    /// </summary>
    [Serializable]
    [CreateAssetMenu(menuName = "BSOAP/Values/BoolValue", fileName = "BB_")]
