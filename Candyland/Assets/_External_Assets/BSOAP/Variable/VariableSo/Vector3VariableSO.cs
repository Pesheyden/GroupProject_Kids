...
{
    /// <summary>
    /// Serializable class that represents a Vector3 scriptable object variable.
    /// </summary>
    [Serializable]
    [CreateAssetMenu(menuName = "BSOAP/Values/Vector3Value", fileName = "BV3_")]
