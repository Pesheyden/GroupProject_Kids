...
{
    /// <summary>
    /// Custom property drawer for DoubleVariable.
    /// </summary>
    [CustomPropertyDrawer(typeof(DoubleVariable))]
    public class DoubleVariableDrawer : PropertyDrawer
    {
        ...
        private void DrawSubAssetProperty(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (variableProperty.objectReferenceValue != null)
            {
                ...
                GUI.enabled = false;
                variableProperty.objectReferenceValue = EditorGUI.ObjectField(objectFieldRect, variableProperty.objectReferenceValue, typeof(DoubleVariableSO), variableProperty.serializedObject.targetObject);
                GUI.enabled = true;
                ...
                if (_isPropertyShown)
                {
                    ...
                    valueProperty.doubleValue = EditorGUI.DoubleField(valuePosition, valueProperty.doubleValue);
        ...
        { 
            ...
            variableProperty.objectReferenceValue = EditorGUI.ObjectField(objectFieldPosition, variableProperty.objectReferenceValue, typeof(DoubleVariableSO), variableProperty.serializedObject.targetObject);
            variableProperty.serializedObject.ApplyModifiedProperties();
        ...
        /// <summary>
        /// Creates a new DoubleVariableSO as a sub-asset.
        /// </summary>
        public DoubleVariableSO CreateSubVariable(Object parentObject, string name)
        {
            var variableSO = ScriptableObject.CreateInstance<DoubleVariableSO>();
