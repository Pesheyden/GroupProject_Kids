...
namespace BSOAP.Variables.Drawers
{
    ...
    public class Vector4VariableDrawer : PropertyDrawer
    {
        ...
        private void DrawSubAssetProperty(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (variableProperty.objectReferenceValue != null)
            {
                ...
                GUI.enabled = false;
                variableProperty.objectReferenceValue = EditorGUI.ObjectField(objectFieldRect, variableProperty.objectReferenceValue, typeof(Vector4VariableSO), variableProperty.serializedObject.targetObject);
                GUI.enabled = true;
        ...
        { 
            ...
            variableProperty.objectReferenceValue = EditorGUI.ObjectField(objectFieldPosition, variableProperty.objectReferenceValue, typeof(Vector4VariableSO), variableProperty.serializedObject.targetObject);
            variableProperty.serializedObject.ApplyModifiedProperties();
        ...
        /// </summary>
        public Vector4VariableSO CreateSubVariable(Object parentObject, string name)
        {
            //Creating Instance and renaming it to the property name
            var variableSO = ScriptableObject.CreateInstance<Vector4VariableSO>();
