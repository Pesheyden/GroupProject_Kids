...
{
    /// <summary>
    /// Custom property drawer for ObjectVariable.
    /// </summary>
    [CustomPropertyDrawer(typeof(ObjectVariable))]
    public class ObjectVariableDrawer : PropertyDrawer
    {
        ...
        private void DrawSubAssetProperty(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (variableProperty.objectReferenceValue != null)
            {
                ...
                GUI.enabled = false;
                variableProperty.objectReferenceValue = EditorGUI.ObjectField(objectFieldRect, variableProperty.objectReferenceValue, typeof(ObjectVariableSO), variableProperty.serializedObject.targetObject);
                GUI.enabled = true;
                ...
                if (_isPropertyShown)
                {
                    ...
                    valueProperty.objectReferenceValue = EditorGUI.ObjectField(valuePosition, valueProperty.objectReferenceValue, typeof(Object), variableProperty.serializedObject.targetObject);
        ...
        { 
            ...
            variableProperty.objectReferenceValue = EditorGUI.ObjectField(objectFieldPosition, variableProperty.objectReferenceValue, typeof(ObjectVariableSO), variableProperty.serializedObject.targetObject);
            variableProperty.serializedObject.ApplyModifiedProperties();
        ...
        /// </summary>
        public ObjectVariableSO CreateSubVariable(Object parentObject, string name)
        {
            //Creating Instance and renaming it to the property name
            var variableSO = ScriptableObject.CreateInstance<ObjectVariableSO>();
