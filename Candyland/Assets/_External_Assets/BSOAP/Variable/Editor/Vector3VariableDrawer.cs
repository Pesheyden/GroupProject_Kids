    ...
    public class Vector3VariableDrawer : PropertyDrawer
    {
        ...
        private void DrawSubAssetProperty(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (variableProperty.objectReferenceValue != null)
            {
                ...
                GUI.enabled = false;
                variableProperty.objectReferenceValue = EditorGUI.ObjectField(objectFieldRect, variableProperty.objectReferenceValue, typeof(Vector3VariableSO), variableProperty.serializedObject.targetObject);
                GUI.enabled = true;
        ...
        { 
            ...
            variableProperty.objectReferenceValue = EditorGUI.ObjectField(objectFieldPosition, variableProperty.objectReferenceValue, typeof(Vector3VariableSO), variableProperty.serializedObject.targetObject);
            variableProperty.serializedObject.ApplyModifiedProperties();
        ...
        /// </summary>
        public Vector3VariableSO CreateSubVariable(Object parentObject, string name)
        {
            //Creating Instance and renaming it to the property name
            var variableSO = ScriptableObject.CreateInstance<Vector3VariableSO>();
