    ...
    public class StringVariableDrawer : PropertyDrawer
    {
        ...
        private void DrawSubAssetProperty(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (variableProperty.objectReferenceValue != null)
            {
                ...
                GUI.enabled = false;
                variableProperty.objectReferenceValue = EditorGUI.ObjectField(
                    objectFieldRect,
                    variableProperty.objectReferenceValue,
                    typeof(StringVariableSO),
            ...
            else
            {
                ...
                {
                    variableProperty.objectReferenceValue = CreateSubVariable(
        ...
        /// </summary>
        public StringVariableSO CreateSubVariable(Object parentObject, string name)
        {
            //Creating Instance and renaming it to the property name
            var variableSO = ScriptableObject.CreateInstance<StringVariableSO>();
