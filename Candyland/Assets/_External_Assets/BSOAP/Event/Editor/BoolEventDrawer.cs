...
[CustomPropertyDrawer(typeof(BoolEventSo))]
public class BoolEventPropertyDrawer : PropertyDrawer
{
    ...
    private void DrawSubAssetProperty(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (property.objectReferenceValue != null)
        {
            ...
            property.objectReferenceValue = EditorGUI.ObjectField(objectFieldRect, property.objectReferenceValue,
                typeof(BoolEventSo), property.serializedObject.targetObject);
            GUI.enabled = true;
    ...
    /// </summary>
    public BoolEventSo CreateSubVariable(Object parentObject, string name)
    {
        //Creating Instance and renaming it to the property name
        var variableSO = ScriptableObject.CreateInstance<BoolEventSo>();
